import{S as _,N as j,P as Y,i as m,A as K,a as Q}from"./assets/vendor-ChAY3moA.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function o(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=o(n);fetch(n.href,r)}})();document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".events-swiper");e&&new _(e,{modules:[j,Y],slidesPerView:1,spaceBetween:24,breakpoints:{768:{slidesPerView:2},1440:{slidesPerView:3}},pagination:{el:".ev-pagination",clickable:!0,renderBullet:(t,o)=>`<li class="${o}" aria-label="Go to slide ${t+1}"></li>`,bulletClass:"ev-dot",bulletActiveClass:"ev-dot--active"},navigation:{nextEl:".events-swiper-btn-next",prevEl:".events-swiper-btn-prev"},watchOverflow:!0})});const p=document.getElementById("modal-backdrop");function F(e){let t=document.querySelector(".modal");t?t.querySelector(".event-title").textContent=e:(t=document.createElement("div"),t.classList.add("modal"),t.innerHTML=`
    ...
    `;u.innerHTML=s,u.classList.add("is-open"),A.classList.add("no-scroll");const n=u.querySelector(".modal");n.querySelector(".close-btn").addEventListener("click",a),u.addEventListener("click",c),window.addEventListener("keydown",$);const g=n.querySelector(".bookQty");g.value=1;const H=n.querySelector(".increaseQty"),V=n.querySelector(".decreaseQty");H.addEventListener("click",()=>{g.value=Number(g.value)+1}),V.addEventListener("click",()=>{const d=Number(g.value);d>1&&(g.value=d-1)}),n.querySelector(".addToCart").addEventListener("click",()=>{m.success({title:"Успіх",message:`Додано до кошика: ${g.value} шт.`,position:"topRight",timeout:2500})}),n.querySelector(".buyNow").addEventListener("click",d=>{d.preventDefault(),m.info({title:"Покупка",message:"Дякуємо за покупку!",position:"topRight",timeout:2500}),setTimeout(a,2500)}),new K(n.querySelector(".accordion-container"),{duration:300,showMultiple:!0})}catch(t){console.error("Error fetching book:",t),m.error({title:"Помилка",message:"Не вдалося завантажити книгу",position:"topRight",timeout:2500})}}const S="https://books-backend.p.goit.global",Z="/books/category-list",W="/books/top-books",J="/books/category",X=10,ee=24,i={categoryToggleBtn:document.querySelector("[data-category-list-toggle]"),categoryMenuContainer:document.querySelector("[data-category-list]"),categoryListElement:document.querySelector(".books-categories-list"),booksContainer:document.querySelector(".js-books-list"),showMoreBtn:document.querySelector(".books-show-more-btn"),booksShowingCount:document.querySelector(".books-showing-count")};let y=[],v="All categories",b=[],f=0;function C(){return window.innerWidth<768?X:ee}async function B(e,t={}){try{const{data:o}=await Q(e,t);return o}catch(o){throw m.error({title:"Error",titleColor:"#ffffff",message:`Request failed: <u>${o.message}</u>`,messageColor:"#ffffff",backgroundColor:"#ef4040",position:"topRight",timeout:4e3,animateInside:!0,progressBar:!1,close:!1,closeOnClick:!0}),o}}async function te(){return(await B(`${S}${Z}`)).map(t=>t.list_name)}async function oe(){return(await B(`${S}${W}`)).flatMap(t=>t.books)}async function se(e){const t={category:e};return await B(`${S}${J}`,{params:t})}function ne(e){const t=`
  ...
  `;l.innerHTML=t,l.classList.add("is-open"),R.classList.add("no-scroll");const o=l.querySelector(".modal-close"),s=l.querySelector("#register-form");o.addEventListener("click",w),l.addEventListener("click",I),window.addEventListener("keydown",D),s.addEventListener("submit",pe)}function w(){l.classList.remove("is-open"),R.classList.remove("no-scroll"),l.innerHTML="",window.removeEventListener("keydown",D),l.removeEventListener("click",I)}function I(e){e.target===l&&w()}function D(e){e.key==="Escape"&&w()}function pe(e){e.preventDefault();const t=e.target,o=t.elements.name,s=t.elements.email,n=o.value.trim(),r=s.value.trim();t.querySelectorAll("input, textarea").forEach(c=>be(c)),t.querySelectorAll(".error-text").forEach(c=>c.remove());let a=!1;n||(E(o,"Name is required"),a=!0),r?fe(r)||(E(s,"Please enter a valid email"),a=!0):(E(s,"Email is required"),a=!0),!a&&(m.success({message:"Registration successful!",position:"topRight",timeout:2500}),setTimeout(()=>w(),2500))}function E(e,t){e.classList.add("error"),e.dataset.originalPlaceholder||(e.dataset.originalPlaceholder=e.placeholder);const o=document.createElement("p");o.classList.add("error-text"),o.textContent=t,e.insertAdjacentElement("afterend",o)}function be(e){e.classList.remove("error"),e.dataset.originalPlaceholder&&(e.placeholder=e.dataset.originalPlaceholder)}function fe(e){return/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(e)}
